...
if __name__ == '__main__':
    ...
    for i in range(0, len(count)):
        ...
        if os.path.isfile(path) and path.endswith('json'):
            ...
            PIL.Image.fromarray(img).save(osp.join(jpgs_path, count[i].split(".")[0]+count[i].split(".")[1]+'.jpg'))
            ...
            utils.lblsave(osp.join(pngs_path, count[i].split(".")[0]+count[i].split(".")[1]+'.png'), new)
